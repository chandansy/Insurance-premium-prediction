...
class DataTransformation:
    ...
    def get_data_transformation_obj(self):
        try:
            ...
            logging.info('Started preprocessing pipeline initiated')
            ...
            preprocessor=ColumnTransformer([
                ...
                ('cat_pipeline',cat_pipeline,catergorical_cols)
            ])
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info('An error has occured during data transformation')
            raise CustomException(e,sys)
...
if __name__ == "__main__":
    ...
    tr,te,pre = obj1.initiate_data_transformation(train,test)